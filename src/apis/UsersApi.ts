...
export class UsersApi extends runtime.BaseAPI {
     ...
     * Get current user
     */
    async getCurrentUserInfoRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<UserInfo>> {
     ...
     * Get current user
     */
    async getCurrentUserInfo(initOverrides?: RequestInit): Promise<UserInfo> {
