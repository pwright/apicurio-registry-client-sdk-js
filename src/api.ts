...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        referencesByContentHash: async (UNKNOWN_PARAMETER_NAME: , options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'UNKNOWN_PARAMETER_NAME' is not null or undefined
            assertParamExists('referencesByContentHash', 'UNKNOWN_PARAMETER_NAME', UNKNOWN_PARAMETER_NAME)
            const localVarPath = `/ids/contentHashes/{contentHash}/references`
                .replace(`{${"contentHash"}}`, encodeURIComponent(String(UNKNOWN_PARAMETER_NAME)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        referencesByContentId: async (UNKNOWN_PARAMETER_NAME: , options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'UNKNOWN_PARAMETER_NAME' is not null or undefined
            assertParamExists('referencesByContentId', 'UNKNOWN_PARAMETER_NAME', UNKNOWN_PARAMETER_NAME)
            const localVarPath = `/ids/contentIds/{contentId}/references`
                .replace(`{${"contentId"}}`, encodeURIComponent(String(UNKNOWN_PARAMETER_NAME)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        referencesByGlobalId: async (UNKNOWN_PARAMETER_NAME: , options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'UNKNOWN_PARAMETER_NAME' is not null or undefined
            assertParamExists('referencesByGlobalId', 'UNKNOWN_PARAMETER_NAME', UNKNOWN_PARAMETER_NAME)
            const localVarPath = `/ids/globalIds/{globalId}/references`
                .replace(`{${"globalId"}}`, encodeURIComponent(String(UNKNOWN_PARAMETER_NAME)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const DefaultApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async referencesByContentHash(UNKNOWN_PARAMETER_NAME: , options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ArtifactReference>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.referencesByContentHash(UNKNOWN_PARAMETER_NAME, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Returns a list containing all the artifact references using the artifact contentId.  This operation may fail for one of the following reasons:  * A server error occurred (HTTP error `500`)
         ...
         * @throws {RequiredError}
         */
        async referencesByContentId(UNKNOWN_PARAMETER_NAME: , options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ArtifactReference>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.referencesByContentId(UNKNOWN_PARAMETER_NAME, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Returns a list containing all the artifact references using the artifact global id.  This operation may fail for one of the following reasons:  * A server error occurred (HTTP error `500`)
         ...
         * @throws {RequiredError}
         */
        async referencesByGlobalId(UNKNOWN_PARAMETER_NAME: , options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ArtifactReference>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.referencesByGlobalId(UNKNOWN_PARAMETER_NAME, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        referencesByContentHash(UNKNOWN_PARAMETER_NAME: , options?: any): AxiosPromise<Array<ArtifactReference>> {
            return localVarFp.referencesByContentHash(UNKNOWN_PARAMETER_NAME, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns a list containing all the artifact references using the artifact contentId.  This operation may fail for one of the following reasons:  * A server error occurred (HTTP error `500`)
         * @summary Returns a list with all the references for the artifact with the given content id.
         ...
         * @throws {RequiredError}
         */
        referencesByContentId(UNKNOWN_PARAMETER_NAME: , options?: any): AxiosPromise<Array<ArtifactReference>> {
            return localVarFp.referencesByContentId(UNKNOWN_PARAMETER_NAME, options).then((request) => request(axios, basePath));
        },
        /**
         * Returns a list containing all the artifact references using the artifact global id.  This operation may fail for one of the following reasons:  * A server error occurred (HTTP error `500`)
         * @summary Returns a list with all the references for the artifact with the given global id.
         ...
         * @throws {RequiredError}
         */
        referencesByGlobalId(UNKNOWN_PARAMETER_NAME: , options?: any): AxiosPromise<Array<ArtifactReference>> {
            return localVarFp.referencesByGlobalId(UNKNOWN_PARAMETER_NAME, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public referencesByContentHash(UNKNOWN_PARAMETER_NAME: , options?: AxiosRequestConfig) {
        return DefaultApiFp(this.configuration).referencesByContentHash(UNKNOWN_PARAMETER_NAME, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public referencesByContentId(UNKNOWN_PARAMETER_NAME: , options?: AxiosRequestConfig) {
        return DefaultApiFp(this.configuration).referencesByContentId(UNKNOWN_PARAMETER_NAME, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof DefaultApi
     */
    public referencesByGlobalId(UNKNOWN_PARAMETER_NAME: , options?: AxiosRequestConfig) {
        return DefaultApiFp(this.configuration).referencesByGlobalId(UNKNOWN_PARAMETER_NAME, options).then((request) => request(this.axios, this.basePath));
    }
}
